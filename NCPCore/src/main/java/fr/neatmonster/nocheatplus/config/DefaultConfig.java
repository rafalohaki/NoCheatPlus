...
public class DefaultConfig extends ConfigFile {
    ...
    public DefaultConfig() {
        ...
        set(ConfPaths.BLOCKBREAK_FREQUENCY_VL_DECAY, 0.95, 1200);
        // NoSwing
        ...
        set(ConfPaths.BLOCKINTERACT_SPEED_VL_DECAY, 0.99, 1200);
        // Visible
        ...
        set(ConfPaths.BLOCKINTERACT_VISIBLE_VL_DECAY, 0.99, 1200);
        ...
        set(ConfPaths.BLOCKPLACE_AGAINST_VL_DECAY, 0.99, 1200);
        // AutoSign
        ...
        set(ConfPaths.BLOCKPLACE_FASTPLACE_VL_DECAY, 0.95, 1200);
        // Reach
        ...
        set(ConfPaths.COMBINED_IMPROBABLE_VL_DECAY, 0.95, 1200);
        // Invulnerable
        ...
        set(ConfPaths.FIGHT_SELFHIT_VL_DECAY, 0.99, 1200);
        // Speed
        ...
        set(ConfPaths.INVENTORY_FASTCLICK_VL_DECAY, 0.99, 1200);
        // InstantBow
        ...
        set(ConfPaths.MOVING_PASSABLE_VL_DECAY, 0.99, 1200);
        ...
        set(ConfPaths.MOVING_SURVIVALFLY_VL_DECAY, 0.95, 1200);
        ...
        set(ConfPaths.MOVING_VEHICLE_ENVELOPE_VL_DECAY, 0.99, 1200);
        // Messages
