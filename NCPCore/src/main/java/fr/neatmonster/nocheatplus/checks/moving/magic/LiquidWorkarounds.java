...
public class LiquidWorkarounds {
    ...
    private static Double downwardCases(final double baseSpeed, final double frictDist, final PlayerMoveData lastMove,
            final PlayerMoveData pastMove1, final MovingData data, final double yDistance, final PlayerLocation from,
