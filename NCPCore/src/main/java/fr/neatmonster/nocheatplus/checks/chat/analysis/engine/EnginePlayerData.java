...
public class EnginePlayerData implements IData{
        ...
        public EnginePlayerData(final ChatConfig cc, final WordProcessorFactory factory) {
                final EnginePlayerConfig config = cc.textEnginePlayerConfig;
                processors.addAll(factory.createProcessors(config));
        }
