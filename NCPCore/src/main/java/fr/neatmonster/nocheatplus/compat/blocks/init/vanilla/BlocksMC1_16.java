...
public class BlocksMC1_16 implements BlockPropertiesSetup{
    ...
    public void setupBlockProperties(WorldConfigProvider<?> worldConfigProvider) {
        ...
        if (config.getBoolean(ConfPaths.BLOCKBREAK_DEBUG, config.getBoolean(ConfPaths.CHECKS_DEBUG, false))) StaticLog.logInfo("Added block-info for Minecraft 1.16 blocks.");
    }
}
