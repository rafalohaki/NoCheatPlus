...
public class BlockFlags {
     ...
     */
    public static long getBlockFlags(final Material mat) {
     ...
     * @return the block flags
     */
    public static long getBlockFlags(final String id) {
     ...
     *            the flags
     */
    public static void setBlockFlags(final Material blockType, final long flags) {
        try {
     ...
     *            the flags
     */
    public static void setBlockFlags(final String id, final long flags) {
